  ...
  abilities: {
    ability1: {
      ...
      execute: function(gameState, target) {
        //place-holder
        console.log('AI uses ability1 on', target);
        target.health = (target.health || 100) - this.damage;
        console.log(`${target.name} health reduced to ${target.health}`);
        return {
          success: true,
          message: `AI's ability1 dealt ${this.damage} damage to ${target.name}!`
        };
      }
    },
    ability2: {
      ...
      execute: function(gameState, self) {
        //place-holder
        console.log('AI uses ability2');
        //place-holder
        return {
          success: true,
          message: `AI's ability2 activated!`
        };
      }
    }
  }
...
window.abilityMap['AI'] = window.AIAbilities;
