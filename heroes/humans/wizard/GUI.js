const WizardData = {
  ...
  id: 'humans',
  abilities: [
    { choice: 'Ultimate spell', label: 'Ultimate', description: 'Deal 40 HP AOE, including underground. Cannot be blocked. ALL inflicted heroes cannot heal for 4 turns. Uses 10 mana.' },
