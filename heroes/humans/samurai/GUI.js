const SamuraiData = {
  ...
  abilities: [
    ...
    { choice: 'Triple Strike', label: 'Triple Strike', description: 'Replace Double Strike with Triple Strike. Triple Strike deals 75 HP but a 6 turn CD.' }
  ],
  hp: 55,
  speed: 55,
  tileMove: 4,
  passive: {
    label: 'Honor',
    description: 'If this hero lands the killing blow of a hero using Honor. He permanently gains +10 HP, +10 to Honor & Double Strike.'
  },
  moveset: [
    {
